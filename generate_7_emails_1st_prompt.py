...
API and save them into "7_emails_1st_prompt".
...
Usage:
  python3.12 generate_7_emails_1st_prompt.py
  python3.12 generate_7_emails_1st_prompt.py --api-key sk-...
  python3.12 generate_7_emails_1st_prompt.py --model gpt-5.6-sol
  python3.12 generate_7_emails_1st_prompt.py --overwrite
...
OUTPUT_DIR = ROOT / "7_emails_1st_prompt"
